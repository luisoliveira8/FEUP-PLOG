<NotepadPlus>
    <UserLang name="Prolog" ext="pl" udlVersion="2.1">
        <Settings>
        ...
        <Styles>
            ...
            <WordsStyle name="NUMBERS" fgColor="000080" bgColor="FFFFFF" fontName="" fontStyle="0" nesting="0" />
